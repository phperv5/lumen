...
+function ($) {
  ...
  var defaults = {
    ...
    swipePanelOnlyClose: false,  //鍙厑璁告粦鍔ㄥ叧闂紝涓嶅厑璁告粦鍔ㄦ墦寮€渚ф爮
    pushAnimationDuration: 400  //涓嶈鍔ㄨ繖涓紝杩欐槸瑙ｅ喅瀹夊崜 animationEnd 浜嬩欢鏃犳硶瑙﹀彂鐨刡ug
  };
          ...
          if (p.input.length > 0) {
              ...
              if (!p.inline) {
                  p.input.on("click", function(e) {
                    openOnInput(e);
                    //淇閮ㄥ垎瀹夊崜绯荤粺涓嬶紝鍗充娇璁剧疆浜唕eadonly渚濈劧浼氬脊鍑虹郴缁熼敭鐩樼殑bug
...
+function ($) {
  ...
  $.openPanel = function (panel) {
      ...
      if(panel === 'left' || panel === 'right') panel = ".panel-" + panel;  //鍙互浼犲叆涓€涓柟鍚�
...
+function ($) {
  ...
  var Router = function() {
    ...
    this.stack.setItem("back", "[]");  //杩斿洖鏍�, {url, pageid, stateid}
    this.stack.setItem("forward", "[]");  //鍓嶈繘鏍�, {url, pageid, stateid}
  ...
  Router.prototype.init = function() {
    ...
    //绗竴娆″姞杞界殑鏃跺€欙紝鍒濊瘑璇濆綋鍓嶉〉闈㈢殑state
    ...
    window.addEventListener('load', function() {
      //瑙ｅ喅safari鐨勪竴涓猙ug锛宻afari浼氬湪棣栨鍔犺浇椤甸潰鐨勬椂鍊欒Е鍙� popstate 浜嬩欢锛岄€氳繃setTimeout 鍋氬欢杩熸潵蹇界暐杩欎釜閿欒鐨勪簨浠躲€�
      //鍙傝€� https://github.com/visionmedia/page.js/pull/239/files
      setTimeout(function() {
  ...
  //鏍规嵁url鑾峰彇椤甸潰鐨凞OM锛屽鏋滄槸涓€涓唴鑱旈〉闈紝鍒欑洿鎺ヨ繑鍥烇紝鍚﹀垯鐢╝jax鍔犺浇
